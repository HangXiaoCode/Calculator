...
MyButton1 = Button(master, text="1", width=10, command=lambda:callback(1))
MyButton1.grid(row=0, column=0)

MyButton2 = Button(master, text="4", width=10, command=lambda:callback(4))
MyButton2.grid(row=1, column=0)

MyButton3 = Button(master, text="7", width=10, command=lambda:callback(7))
MyButton3.grid(row=2, column=0)

MyButton4 = Button(master, text="2", width=10, command=lambda:callback(2))
MyButton4.grid(row=0, column=1)

MyButton5 = Button(master, text="5", width=10, command=lambda:callback(5))
MyButton5.grid(row=1, column=1)

MyButton6 = Button(master, text="8", width=10, command=lambda:callback(8))
MyButton6.grid(row=2, column=1)

MyButton7 = Button(master, text="3", width=10, command=lambda:callback(3))
MyButton7.grid(row=0, column=2)

MyButton8 = Button(master, text="6", width=10, command=lambda:callback(6))
MyButton8.grid(row=1, column=2)

MyButton9 = Button(master, text="9", width=10, command=lambda:callback(9))
MyButton9.grid(row=2, column=2)

MyButton0 = Button(master, text="0", width=10, command=lambda:callback(0))
